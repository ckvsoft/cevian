...
- DDL im Modul **nur über `execDdl()`** (ein einziger
  Framework-Einstiegspunkt). Nach Framework 0.18.3 sind außerdem
  `tableExists/databaseName/showCreateTable/dropTable/truncateTable/
  executeSqlFile` verfügbar, sodass Modulcode für Schema-Checks und
  Dump-Replay KEIN exec mehr braucht.
